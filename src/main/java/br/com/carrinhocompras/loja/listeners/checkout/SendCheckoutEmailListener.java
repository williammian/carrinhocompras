package br.com.carrinhocompras.loja.listeners.checkout;
...
import br.com.carrinhocompras.loja.daos.CheckoutDAO;
import br.com.carrinhocompras.loja.infra.MailSender;
import br.com.carrinhocompras.loja.models.Checkout;
...
public class SendCheckoutEmailListener implements MessageListener{
	...
	public void onMessage(Message message) {
		...
		try {
			...
			mailSender.send("compras@carrinhocompras.com.br", checkout.getBuyer()
